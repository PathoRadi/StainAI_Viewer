...
// const CELLCOUNT_COLOR = 'rgba(142, 68, 173, 0.3)';
...
//       return p2.y - p1.y;
//     })
//     .style('fill', d => CLASS_COLORS[d.type] || CELLCOUNT_COLOR)
//     .style('display', 'none');
// }
...
//   d3.selectAll('rect')
//     .style('fill', d => CLASS_COLORS[d.type] || CELLCOUNT_COLOR)
//     .style('display', d => types.includes(d.type) ? 'block' : 'none');
// }
...
function getOverlayMode() {
  return getSvgOverlayNode() ? 'svg' : 'html';
}
