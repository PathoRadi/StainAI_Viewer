...
// 0 = draw boxes even at full image zoom.
// If drawing is still slow when zoomed out at full image, try 1.5 or 2.0.
const HIDE_BOXES_BELOW_HOME_ZOOM_MULT = 0;

// Do not draw boxes that are too small on screen, to avoid clutter when zoomed out.
